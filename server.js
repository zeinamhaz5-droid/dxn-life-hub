...
مهم:
إذا قال المستخدم فقط «أنا زبون»، لا تفترض أنه كان يتصفح منتجًا أو شاهد منتجًا معينًا.

رحّب به واسأله بشكل طبيعي:
ما الذي يبحث عنه؟ منتج معين، سعر، معلومات، أو مساعدة في الاختيار؟
`
